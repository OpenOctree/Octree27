...
namespace Clobscode
{
	...
	bool SurfTemplate5::getSubelements(vector<unsigned long> &all, 
		...
		HexRotation hrot;
		vector<unsigned long> rotated,number (5,0);
		if(in.size()!=5)
			return false;
		rotated.reserve(8);
	...
	vector<unsigned long> SurfTemplate5::getEdges(int p){
	...
	void SurfTemplate5::PatternA(vector<unsigned long> &all, vector<MeshPoint> &pts,
								 list<MeshPoint> &newpts,
		...
		vector<unsigned long> ele3(5,0);
		vector<unsigned long> ele4(4,0);
		vector<unsigned long> ele5(4,0);
		vector<unsigned long> ele6(4,0);
		vector<unsigned long> ele7(4,0);
		vector<unsigned long> ele8(4,0);
		vector<unsigned long> ele9(4,0);
	...
	//Pattern B in paper
	void SurfTemplate5::PatternB(vector<unsigned long> &all,
								vector<vector<unsigned long> > &eles){
	...
	//Pattern A in paper
	void SurfTemplate5::PatternC(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
	...
	vector<unsigned long> SurfTemplate5::searchPivote(vector<unsigned long> &doubles){
		vector<unsigned long> edges = getEdges(doubles[0]),order(3,0);
		int con1=0,con2=0;
