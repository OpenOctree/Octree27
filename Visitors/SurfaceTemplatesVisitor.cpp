...
namespace Clobscode
{
    ...
    void SurfaceTemplatesVisitor::setIdx(unsigned long &e_idx) {
        this->e_idx = &e_idx;
    }
    ...
    bool SurfaceTemplatesVisitor::visit(Octant *o) {
        ...
        list<vector<unsigned long> > new_eles_lst;
        for (unsigned long i=0; i<sub_elements.size(); i++) {
            ...
            if (sub_elements[i].size() == 5) {
                ...
                vector<vector<unsigned long> > new_sub_eles = p.getSubElements(nds_inside);

                for (unsigned long j=0; j<new_sub_eles.size(); j++) {
            ...
            if (sub_elements[i].size() == 8) {
                ...
                vector<vector<unsigned long> > new_sub_eles = h.getSubElements(*meshpts,
                                                                              *newpts,
                                                                              *input,
                                                                              *e_idx,
                                                                              o->possibles,
        ...
        list<vector<unsigned long> >::iterator ne_iter;
        sub_elements.clear();
