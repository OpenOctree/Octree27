...
namespace Clobscode
{
	...
	SurfPyramid::SurfPyramid(vector<unsigned long> &mypoints){
        if (mypoints.size()!=5) {
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
    vector<vector<unsigned long> > SurfPyramid::getSubElements(vector<bool> &inside_state){
    
        vector<vector<unsigned long> > sub_ele, digaonals;
        
        //detect diagonals over
        vector<unsigned long> base(4,0);
        for (unsigned long i=0; i<4; i++) {
            base[i] = i;
        }
        
        vector<unsigned long> diag(2,0);
        ...
        vector<unsigned long> tet1 (4,0), tet2 (4,0);
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
    vector<vector<unsigned long> > SurfPyramid::getTetras(){
