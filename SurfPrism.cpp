...
namespace Clobscode
{
	...
	SurfPrism::SurfPrism(vector<unsigned long> &mypoints){
        if (mypoints.size()!=6) {
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
    vector<vector<unsigned long> > SurfPrism::getSubElements(vector<bool> &inside_state){
    ...
    vector<unsigned long> SurfPrism::sortDiagonals(list<unsigned long> &original){
    ...
    bool SurfPrism::oneRepeated(vector<unsigned long> &original, vector<unsigned long> &result){
    ...
    unsigned long SurfPrism::opposite(unsigned long idx){
        return (idx+3)%6;
    }
    ...
    void SurfPrism::oppositeFace(unsigned long idx, vector<unsigned long> &base){
        if (idx==0 || idx==3) {
            base[0] = 1;
            base[1] = 4;
            base[2] = 5;
    ...
    //--------------------------------------------------------------
    //--------------------------------------------------------------
    vector<vector<unsigned long> > SurfPrism::getTetras(){
        vector<vector<unsigned long> > tetras;
        tetras.reserve(6);
        
        vector<unsigned long> t0(4,-1);
        t0[0]=points[0];
        t0[1]=points[2];
        t0[2]=points[3];
        t0[3]=points[1];
