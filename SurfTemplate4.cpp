...
namespace Clobscode
{
	...
	bool SurfTemplate4::getSubelements(vector<unsigned long> &all, 
									  vector<unsigned long> &in,
									  vector<vector<unsigned long> > &newele){
		
		HexRotation hrot;
		vector<unsigned long> rotated,number (4,0);
		if((int)in.size()!=4)
			return false;
		rotated.reserve(8);
		...
		for (unsigned long i=0;i<4;i++){
			vector<unsigned long> edsi = getEdges(in[i]);
			for (unsigned long j=0;j<edsi.size();j++){
	...
	vector<unsigned long> SurfTemplate4::getEdges(int p){
		vector<unsigned long> edges (3,0);
		if(p==0){
			edges[0]=1;
			edges[1]=3;
			edges[2]=4;
	...
	//Pattern G in paper
	void SurfTemplate4::PatternA(vector<unsigned long> &all, 
	...
	//Pattern C in paper
	void SurfTemplate4::PatternB(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
		
		eles.reserve(4);
		vector<unsigned long> ele1(5,0);
		vector<unsigned long> ele2(5,0);
		vector<unsigned long> ele3(4,0);
		vector<unsigned long> ele4(4,0);
	...
	//Pattern E in paper
	void SurfTemplate4::PatternC(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
	...
	//Pattern D in paper
	void SurfTemplate4::PatternD(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
	...
	//Pattern  F in paper
	void SurfTemplate4::PatternE(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
	...
	//Pattern B in paper
	void SurfTemplate4::PatternF(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
		
		eles.reserve(2);
		vector<unsigned long> pri1(6,0),pri2(6,0);
	...
	//Pattern A in paper
	void SurfTemplate4::PatternG(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
		
		eles.reserve(5);
		vector<unsigned long> tet1(4,0),tet2(4,0),tet3(4,0),tet4(4,0),tet5(4,0);
	...
	void SurfTemplate4::swap(vector<unsigned long> &vec, int pos1, int pos2){
		int aux = vec[pos1];
		vec[pos1] = vec[pos2];
		vec[pos2] = aux;
	}
