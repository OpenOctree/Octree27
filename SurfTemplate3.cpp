...
namespace Clobscode
{
	...
	bool SurfTemplate3::getSubelements(vector<unsigned long> &all, 
									  vector<unsigned long> &in,
									  vector<vector<unsigned long> > &neweles){
		
		HexRotation hrot;
		vector<unsigned long> rotated;
		vector<unsigned long> pivotes(3,0);
		if(in.size()!=3)
			return false;
	...
	//Pattern C in paper
	void SurfTemplate3::PatternA(vector<unsigned long> &all, vector<vector<unsigned long> > &eles){
    ...
    //Pattern C in paper
	void SurfTemplate3::PatternA(vector<unsigned long> &all,
	...
	void SurfTemplate3::PatternB(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
	...
	void SurfTemplate3::PatternC(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
	...
	//Pattern A in paper
	void SurfTemplate3::PatternD(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
	...
	void SurfTemplate3::swap(vector<unsigned long> &vec, int pos1, int pos2){
		int aux = vec[pos1];
		vec[pos1] = vec[pos2];
		vec[pos2] = aux;
	}
