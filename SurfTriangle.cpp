...
namespace SurfMesh
{
	//--------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------
	SurfTriangle::SurfTriangle(vector<unsigned long> &fpts){
		mIdxV.assign(3,0);
		mIdxV[0] = fpts[0];
		mIdxV[1] = fpts[1];
		mIdxV[2] = fpts[2];
	...
	//--------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------
	unsigned long &SurfTriangle::operator[](unsigned long pos){
		return mIdxV.at(pos);
	}
	
	//--------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------
	unsigned long SurfTriangle::operator[](unsigned long pos) const{
		return mIdxV.at(pos);
	}
	...
	//--------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------
	Point3D SurfTriangle::computeNormalAtNode(unsigned long nidx, 
										   vector<Point3D> &pts ) 
	{
