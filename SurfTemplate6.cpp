...
namespace Clobscode
{
	...
	bool SurfTemplate6::getSubelements(vector<unsigned long> &all, 
	...
	void SurfTemplate6::PatternA(vector<unsigned long> &all, 
	...
	void SurfTemplate6::PatternB(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
	...
	void SurfTemplate6::PatternC(vector<unsigned long> &all, 
								vector<vector<unsigned long> > &eles){
