...
namespace patterns {
	...
	const PatternFactory::PatternTemplateMap PatternFactory::pattern_table[] = {
      ...
      {27, 5},     // 4B --> T4B  [0 1 3 4]
      // T5A
      {31, 6},     // 5A --> T40  [ 0 1 2 3 4 ]
      // T6
      {221, 7},    // 6A --> T6   [ 0 3 2 4 7 6 ]
      {40, 0},     // 2C --> T6   [ 3 5 ]
      {88, 0},     // 3C --> T6   [ 3 4 6 ]
      //{141, 0},    // 4B --> T6   [ 0 3 2 7 //In T4B
      {77, 0},     // 4C --> T6   [ 0 3 2 6 ]
      {29, 0},     // 4C.2 > T6   [ 0 3 2 4 ] //*
      {93, 0},     // 5B --> T6   [ 0 3 2 4 6 ]
      // T7
      {191, 8},    //  7 --> T7   [ 0 1 2 3 4 5 7 ]
/* remove_T8 */
      // T8
      {90, 0},     // 4F --> T8   [ 1 3 4 6 ]
      {173, 0},    // 5C --> T8   [ 0 3 2 5 7 ]
      {175, 0},    // 6B --> T8   [ 0 1 3 2 5 7 ]
      {235, 0},    // 6C --> T8   [ 0 1 3 5 7 6 ]
      //{255, 9},    //  8 --> T8   [ 0 1 2 3 4 5 6 7 ]
/* /remove_T8 */
	};
